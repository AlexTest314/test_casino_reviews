export const updateData = (data, toClear = false) => {
  if (toClear) {
    ...
    document.getElementById("main").insertAdjacentHTML(
      ...
      `
		...
		<div class='casino-logo'>
		  <image src=${logo} alt='casino-logo'></image>
		</div>
		<div class='casino-info'>
		  ...
		  <div class='flag-rating-info'>
			 <div class='flag'>
				<image src=${flag} alt='casino-flag'></image>
			 </div>
			 <div class='rate'>${rate}</div>
			 <div class='stars'>
				<image src='./icons/star_rounded.svg' alt='star-icon'></image>
				<image src='./icons/star_rounded.svg' alt='star-icon'></image>
				<image src='./icons/star_rounded.svg' alt='star-icon'></image>
				<image src='./icons/star_rounded.svg' alt='star-icon'></image>
				<image src='./icons/star_rounded_empty.svg' alt='star-icon'></image>
			 </div>
		  </div>
		</div>
		<div class='casino-bonus'>
		  ...
		  <div class='bonus-spins popup'>
			 ...
			 <div class='popup-content'>
				...
				<div class='popup-welcome' id='copyCode'>
				  <div class='copy-code-content' id='copyPop' hidden>
					 <input class='my-input' id='myInput'>
					 <p>
						<image src='./icons/check.svg' alt='check-icon'></image>
						Code copied to clipboard
					 </p>
				  </div>
				  <p class='welcome-text copy-code-hover'>
					 WELCOME
